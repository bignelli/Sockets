...
public final class StringTranslations {
    ...
    //JEI
    public static final String DIAMOND_GEM_JEI = "info.sockets.jei.diamond_gem";
    public static final String EMERALD_GEM_JEI = "info.sockets.jei.emerald_gem";
    public static final String ENCHANTFUL_GEM_JEI = "info.sockets.jei.enchantful_gem";
